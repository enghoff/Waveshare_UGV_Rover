...
#
#     ssh rpi '~/ugv/install_opencv.sh'                 # fetch it from PyPI
#     ssh rpi '~/ugv/install_opencv.sh /tmp/opencv.whl' # or from a wheel already here
#     ssh rpi '~/ugv/install_opencv.sh --force'         # unpack again over the top
#
