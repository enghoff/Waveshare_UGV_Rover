...
|---|---|---|---|
| 2026-09-10 | [Bounded entity fitting is faster, but loses correct identities](2026-09-10-bounded-entity-fitting.md) | none; R-WS-13 stays open | three local drives; full prototype takes 34.7 s against 87.5 s on the labelled drive but retains only 50.7% of correct pairs; no negative-evidence correction; existing resolver remains selected; deployment blocked by connectivity |
