...
SCRIPT_TOOL: dict[str, Any] = {
    ...
    "function": {
        ...
        "description": (
            ...
            "look at a value before it acts, several acts that have to happen in a "
            "particular order, or two things that have to happen at the same time. "
            "Do not use it for anything one of your other "
            ...
            "writing a program about it. Every driving call blocks until the "
            "move is over, so doing two things at once means a "
            "`with alongside(job):` block: the job runs on its own while the "
            "block drives, and ends when the block does. It is written against "
