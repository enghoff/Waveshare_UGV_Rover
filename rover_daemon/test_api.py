...
def test_schemas():
    ...
    control = ["set_vision", "nav_status", "map_png", "camera_jpeg", "clear_map",
               ...
               # Whether the depth camera is awake, which is a control call for
               # the same shape of reason as the two above: what the rover can
               # afford is a decision about the rover rather than about the
               # conversation, and the answer is three states a console draws a
               # lamp from rather than anything a model can say out loud. There
               ...
               # answer with identifiers, cosines and the placement as the
               # store writes it, none of which a model can say out loud or
               # reason about correctly. What a model is offered instead is
