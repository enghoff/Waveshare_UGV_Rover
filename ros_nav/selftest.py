...
decides to go, and how it follows a route once it has decided. `test_harness.py`
holds the tally they share and the `sys.path` setup they all need.
"""
import sys
...
def main():
    for test in (*CHASSIS_TESTS, *ODOMETRY_TESTS, *SCAN_TESTS, *BRIDGE_TESTS,
                 *CONFIG_TESTS, *PLANNING_TESTS, *CONTROL_TESTS):
        test()
